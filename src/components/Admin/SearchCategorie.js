...
import { searchActionCategorie } from "../../actions/search.action";
        ...
        >
          {searchResults.map((result, index) => (
            <>
              ...
              >
                <span style={{ color: "var(--var-cream)", margin: "0px 4px" }}>Id : </span>
                {result.id_categ} |
                <span style={{ color: "var(--var-cream)", margin: "0px 4px" }}>Nom : </span>
                {result.nom_categ} |
                <span style={{ color: "var(--var-cream)", margin: "0px 4px" }}>
                  Poids :
                </span>
                {result.poids_categ} kg
              </li>
              <hr
                style={{
